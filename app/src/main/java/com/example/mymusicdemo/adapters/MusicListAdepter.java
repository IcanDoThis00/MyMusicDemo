...
public class MusicListAdepter extends RecyclerView.Adapter<MusicListAdepter.ViewHolder> {
    ...
    public MusicListAdepter (Context context, RecyclerView recyclerView, List<MusicModel> dataSource) {
        mContext = context;
        mRv = recyclerView;
